...
// CREATE TABLE topic(id int(10) not null auto_increment primary key, title varchar(20) not null);
conn.connect();
...
app.set('views ', './views_mysql'); // views_file 디렉토리에 해당 template file 둘 것임
...
// topic 또는 topic/id로 접속했을때의 route
